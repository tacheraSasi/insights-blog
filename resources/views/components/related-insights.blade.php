            ...
            <article class="group">
                <a href="{{ route('insights.show', $related->slug) }}"
                   class="block bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition duration-200">
                    ...
                    <h4 class="font-medium text-neutral-800 dark:text-neutral-200 group-hover:text-green-600 dark:group-hover:text-green-400 transition duration-200 line-clamp-2 mb-2">
                        {{ $related->title }}
                    </h4>

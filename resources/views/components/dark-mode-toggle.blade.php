<div x-data="darkModeToggle()" class="flex items-center">
    <button
        ...
        class="relative inline-flex items-center justify-center w-10 h-6 bg-gray-200 dark:bg-gray-700 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-800"
